...
# 2022-12-14 V2.2.9
1. 增加购买道符强化石*10(每日2000贡献)。

# 2022-12-24 V2.3.0
1. 增加3011-剑气除魔(纯文字修真)H5小号选择。
2. 增加冰火游戏-剑气除魔(纯文字修真)小号选择。
...
# 2023-2-24 V2.3.6
1. 游戏鸭-天子令(修真模拟器)增加小号选择。

# 2023-3-7 V2.3.7
1. 增加饺子手游-天子令(纯文字修真)

# 2023-3-27 V2.3.9
1. 增加五行丹随机宝箱*2(每日300仙缘)。
2. 增加天衍玉*5(每周500仙贝)。

# 2023-4-6 V2.4.0
1. 增加修复羔羊游-剑气除魔(mud)登陆的问题。
2. 增加华为-不朽仙途。

# 2023-4-7 V2.4.1
1. 修复游戏鸭-剑气除魔(纯文字修真)登陆的问题。
2. 修复28手游-剑气除魔(纯文字修真)。
...
# 2023-4-26 V2.4.3
1. 修复冰火游戏-剑气除魔(纯文字修真)获取服务器参数错误的问题。